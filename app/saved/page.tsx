    ...
    <main>
      ...
      <section className="w-11/12 mx-auto py-10">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm text-gray-400">{words.length} words saved</span>
        </div>
        ...
        {words.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 text-center text-gray-400">
            ...
            <p className="text-lg font-medium">No saved words yet</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {words.map((word) => (
              <div
                key={word.id}
                className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-col gap-3 hover:shadow-md transition"
              >
                {/* Word + pronounce */}
