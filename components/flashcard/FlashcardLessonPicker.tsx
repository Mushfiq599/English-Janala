...
export default function FlashcardLessonPicker({ lessons, onSelect }: Props) {
    ...
    return (
        <div>
            <div className="text-center mb-10">
                ...
                >
                    {themeTier === "kids"
                        ? "Which words do you want to practise?"
                        : "Pick a lesson to study"}
                </h2>
                <p style={{ color: "var(--text-secondary)" }} className="text-sm">
                    {themeTier === "scholar"
                        ? "Flip through every word in the lesson at your own pace"
                        : "Tap each card, try to remember the meaning, then flip to check"}
                </p>
            </div>
